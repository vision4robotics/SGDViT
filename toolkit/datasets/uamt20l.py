...
class UAMT20LVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(UAMT20LVideo, self).__init__(name, root, video_dir,
...
class UAMT20LDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(UAMT20LDataset, self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            self.videos[video] = UAMT20LVideo(video,
                                          dataset_root,
