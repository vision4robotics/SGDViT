...
class UAVDarkVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(UAVDarkVideo, self).__init__(name, root, video_dir,
...
def ca():
    ...
    root = '/home/v4r/Dataset/UAVDark70/'
    path=root+'data_seq'
    anno = root + 'anno'
    ...
    return d
class UAVDark70Dataset(Dataset):
    """
    Args:
    ...
    def __init__(self, name, dataset_root, load_img=False):
        ...
        for video in pbar:
            ...
            self.videos[video] = UAVDarkVideo(video,
                                          dataset_root,
